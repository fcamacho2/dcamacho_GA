...
var gpigutloa=this;var gpigutlob=String.prototype.trim?function(a){return a.trim()}:function(a){return a.replace(/^[\s\xa0]+|[\s\xa0]+$/g,"")},gpigutloc=function(a,b){return a<b?-1:a>b?1:0};var gpigutlo;a:{var gpigutlod=gpigutloa.navigator;if(gpigutlod){var gpigutloe=gpigutlod.userAgent;if(gpigutloe){gpigutlo=gpigutloe;break a}}gpigutlo=""};var gpigutlog=function(a,b){var e=gpigutlof;Object.prototype.hasOwnProperty.call(e,a)||(e[a]=b(a))};var gpigutloh=-1!=gpigutlo.indexOf("Opera"),gpigutloi=-1!=gpigutlo.indexOf("Trident")||-1!=gpigutlo.indexOf("MSIE"),gpigutloj=-1!=gpigutlo.indexOf("Edge"),gpigutlok=-1!=gpigutlo.indexOf("Gecko")&&!(-1!=gpigutlo.toLowerCase().indexOf("webkit")&&-1==gpigutlo.indexOf("Edge"))&&!(-1!=gpigutlo.indexOf("Trident")||-1!=gpigutlo.indexOf("MSIE"))&&-1==gpigutlo.indexOf("Edge"),gpigutlol=-1!=gpigutlo.toLowerCase().indexOf("webkit")&&-1==gpigutlo.indexOf("Edge"),gpigutlom=function(){var a=gpigutloa.document;
return a?a.documentMode:void 0},gpigutlon;
a:{var gpigutloo="",gpigutlop=function(){var a=gpigutlo;if(gpigutlok)return/rv\:([^\);]+)(\)|;)/.exec(a);if(gpigutloj)return/Edge\/([\d\.]+)/.exec(a);if(gpigutloi)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(gpigutlol)return/WebKit\/(\S+)/.exec(a);if(gpigutloh)return/(?:Version)[ \/]?(\S+)/.exec(a)}();gpigutlop&&(gpigutloo=gpigutlop?gpigutlop[1]:"");if(gpigutloi){var gpigutloq=gpigutlom();if(null!=gpigutloq&&gpigutloq>parseFloat(gpigutloo)){gpigutlon=String(gpigutloq);break a}}gpigutlon=gpigutloo}
var gpigutlor=gpigutlon,gpigutlof={},gpigutlos=function(a){gpigutlog(a,function(){for(var b=0,e=gpigutlob(String(gpigutlor)).split("."),g=gpigutlob(String(a)).split("."),h=Math.max(e.length,g.length),f=0;0==b&&f<h;f++){var c=e[f]||"",d=g[f]||"";do{c=/(\d*)(\D*)(.*)/.exec(c)||["","","",""];d=/(\d*)(\D*)(.*)/.exec(d)||["","","",""];if(0==c[0].length&&0==d[0].length)break;b=gpigutloc(0==c[1].length?0:parseInt(c[1],10),0==d[1].length?0:parseInt(d[1],10))||gpigutloc(0==c[2].length,0==d[2].length)||gpigutloc(c[2],
d[2]);c=c[3];d=d[3]}while(0==b)}return 0<=b})},gpigutlot;var gpigutlou=gpigutloa.document;gpigutlot=gpigutlou&&gpigutloi?gpigutlom()||("CSS1Compat"==gpigutlou.compatMode?parseInt(gpigutlor,10):5):void 0;var gpigutlov;if(!(gpigutlov=!gpigutlok&&!gpigutloi)){var gpigutlow;if(gpigutlow=gpigutloi)gpigutlow=9<=Number(gpigutlot);gpigutlov=gpigutlow}gpigutlov||gpigutlok&&gpigutlos("1.9.1");gpigutloi&&gpigutlos("9");/*
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
var gpigutlox={};window.gapi=window.gapi||gpigutlox;
;
